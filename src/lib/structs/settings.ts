...
/** JSON Schema for setting
{
  ...
  "properties": {
    ...
    "global": {
      ...
      "title": "Global",
      "description": "Global settings that affect whole site",
      "required": [
        "theme"
      ]
    }
  },
  "description": "Settings for dval.in",
  "required": [
    "user",
    "global"
  ]
...
**/
/**
 * Settings for dval.in
 */
export interface Settings {
	/**
	 * Global settings that affect whole site
	 */
	global: Global;
	/**
	 * User related data
...
const typeMap: any = {
	...
	Global: o([{ json: 'theme', js: 'theme', typ: 3.14 }], 'any'),
	User: o(
		[
			{ json: 'logined', js: 'logined', typ: true },
